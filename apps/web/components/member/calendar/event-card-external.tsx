...
export function EventCardExternal({ event, timeLabel }: EventCardExternalProps) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden rounded-md border border-border-token border-l-[3px] border-l-fg-faint bg-bg-subtle/60 px-2 py-1">
