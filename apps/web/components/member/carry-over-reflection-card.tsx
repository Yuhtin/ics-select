...
export function CarryOverReflectionCard({ reflection }: Props) {
  return (
    <aside className="relative overflow-hidden rounded-tile border border-border-token bg-surface p-6 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[2px] before:bg-reflect">
      <p className="font-sans text-xs font-medium text-reflect">
