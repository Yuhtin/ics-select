...
function PageButton({
  ...
  return (
    <button
      ...
      className={clsx(
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface inline-flex items-center justify-center min-w-7 h-7 px-2 rounded-input font-mono text-[11px] transition-colors',
        active
