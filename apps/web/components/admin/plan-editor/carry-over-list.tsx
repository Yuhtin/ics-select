...
export function CarryOverList({
  ...
  if (candidates.length === 0) {
    return <p className="font-sans text-xs text-fg-mute">No unfinished items to carry over.</p>;
  }
          ...
          <li key={c.id}>
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <div className="flex-1 min-w-0">
                ...
                {c.reflection && (
                  <p className="mt-1 font-sans text-xs text-fg-soft italic line-clamp-2">
